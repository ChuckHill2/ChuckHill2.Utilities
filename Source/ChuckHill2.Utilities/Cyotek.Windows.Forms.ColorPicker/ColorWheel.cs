...
namespace Cyotek.Windows.Forms
{
  ...
  public class ColorWheel : Control, IColorEditor
  {
    ...
    private Brush _transparentBrush = new HatchBrush(HatchStyle.LargeCheckerBoard, Color.FromArgb(225, 225, 225), Color.Transparent); //--Chuck
    ...
    public ColorWheel()
    {
      this.DoubleBuffered = true; //--Chuck
    ...
    protected virtual void CalculateWheel()
    {
      ...
      if (size.Width > 16 && size.Height > 16)
      {
        ...
        for (double angle = 0; angle < 360; angle += _colorStep)
        {
          ...
          colors.Add(new HslColor(_hslColor.A, angle, 1, _hslColor.L).ToRgbColor()); //--Chuck
        }
      }
    ...
    protected override void Dispose(bool disposing)
    {
      if (disposing)
      {
        ...
        if (_transparentBrush != null) //--Chuck
        {
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
      ...
      if (this.AllowPainting)
      {
        ...
        if (_brush != null)
        {
          if (_hslColor.A < 255) //--Chuck
          {
            e.Graphics.FillEllipse(_transparentBrush, ((PathGradientBrush)_brush).Rectangle);
          }
    ...
    protected virtual void SetColor(Point point)
    {
      ...
      newColor = new HslColor(_hslColor.A, angle, saturation, _hslColor.L); //--Chuck
