...
//   
// </summary>
// <copyright file="GradientGroupBox.cs" company="Chuck Hill">
...
namespace ChuckHill2.Forms
{
    ...
    /// Extends System.Windows.Forms.GroupBox to support a gradient color for the background.
    /// </summary>
    [ToolboxItem(true), ToolboxBitmap(typeof(GroupBox))]
    public class GradientGroupBox : GroupBox, IGradientControl
    {
